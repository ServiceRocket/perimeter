...
public abstract class DefaultStatelessTestRunner implements StatelessTestRunner {
    ...
    @Inject protected static WebDriver webDriver;
    @Inject protected static DefaultLabelManager defaultLabelManager;
    @Inject protected static ContentBodyConversionService contentBodyConversionService;
    @Inject protected static ContentLocatorBuilder contentLocatorBuilder;
